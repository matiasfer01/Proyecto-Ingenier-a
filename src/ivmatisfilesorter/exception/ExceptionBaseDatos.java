...
/**
 * Sirve para manejar excepciones personalizadas relacionadas con la base de satos.
 * <p>
 ...
 * <li><code>IVMATIS_EXCEPTION_NO_SE_ENCONTRO_DRIVER</code> para cuando el
...
public class ExceptionBaseDatos extends Exception {
	...
	/**
	 * Constructor para crear una instancia de BaseDatosException.
	 * 
	 * @param msg
